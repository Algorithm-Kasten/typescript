...
RSpec.describe CircularSinglyLinkedList do
    it 'initialize' do 
    ...
    it 'push_front' do 
        ...
        list.push_front(3)
        expect(list.printall).to eq "3 2 1"
        expect(list.size).to eq 3

        list.push_front(4)
        expect(list.printall).to eq "4 3 2 1"
        expect(list.size).to eq 4

        list.push_front(5)
        expect(list.printall).to eq "5 4 3 2 1"
    ...
    it 'push_back' do 
        ...
        list.push_back(2)
        expect(list.printall).to eq "1 2"
        expect(list.size).to eq 2

        list.push_back(3)
        expect(list.printall).to eq "1 2 3"
        expect(list.size).to eq 3

        list.push_back(4)
        expect(list.printall).to eq "1 2 3 4"
        expect(list.size).to eq 4
    ...
    it 'front' do
        list = CircularSinglyLinkedList.new 
        expect(list.front).to eq nil
        
        list.insertAt(1, 5)
        expect(list.front).to eq 5
        
        list.insertAt(1, 17)
        expect(list.front).to eq 17
    ...
    it 'reverse' do 
        ...
        list.reverse
        expect(list.printall).to eq "5 3 1 2 4 6"
